...
$('.modal_close').click(function () {
    ...
    $('#edit_first_modal').css({
        "display": "none"
    });
    $('#edit_second_modal').css({
        "display": "none"
    });
    $('#edit_third_modal').css({
        "display": "none"
    });
    $(document.body).css({
        "overflow": "scroll"
...
$('.edit_feed').click(function () {
    let feed_id = $(this).data('feed-id');
    console.log(feed_id)
    $('#feed_edit_btn').attr('data-feed-id', feed_id);
...
$('#feed_edit_next_btn').click(function () {
...
$('#feed_edit_btn').click(function () {
    let feed_id = $('#feed_edit_btn').attr('data-feed-id');
    console.log(feed_id);
    const file = files[0];
    let img = files[0].name;
